...
# Conversion des colonnes 'Shipment Year', 'Shipment Month', et 'Shipment Day' en une colonne 'date_ship'
...
# Formatage de la colonne 'date_ship' pour qu'elle ait le format 'dd/mm/YYYY'
dataframe['date_ship'] = dataframe['date_ship'].dt.strftime('%d/%m/%Y')

# Affichage du DataFrame résultant avec la colonne 'date_ship' modifiée
print(dataframe)
